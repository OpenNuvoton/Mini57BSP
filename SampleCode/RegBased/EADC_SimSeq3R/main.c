...
int main()
{
    ...
    EADC->CTL = (EADC->CTL & ~(EADC_CTL_ADC0CHSEL_Msk | EADC_CTL_ADC0HWTRGEN_Msk | EADC_CTL_ADC1CHSEL_Msk | EADC_CTL_ADC1HWTRGEN_Msk | EADC_CTL_ADCMODE_Msk | EADC_CTL_ADCSS3R_Msk | EADC_CTL_ADC0SEQSEL_Msk)) |
                ((EADC_EADC0_0 << EADC_CTL_ADC0CHSEL_Pos) | ((EADC_EADC1_0 - EADC_EADC1_0) << EADC_CTL_ADC1CHSEL_Pos) | (0x3 << EADC_CTL_ADCMODE_Pos) | EADC_CTL_ADCEN_Msk | EADC_CTL_ADCSS3R_Msk | (EADC_EADC0_6 << EADC_CTL_ADC0SEQSEL_Pos));
