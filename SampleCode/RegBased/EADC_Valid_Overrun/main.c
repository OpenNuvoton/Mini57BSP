...
int main()
{
    ...
    EADC->CTL = (EADC->CTL & ~(EADC_CTL_ADC0CHSEL_Msk | EADC_CTL_ADC0HWTRGEN_Msk |  EADC_CTL_ADCMODE_Msk)) |
                ((EADC_EADC0_0 << EADC_CTL_ADC0CHSEL_Pos) | (0x0 << EADC_CTL_ADCMODE_Pos) | EADC_CTL_ADCEN_Msk);
    ...
    while (ch != 'q')
    {
        printf("Do first time EADC conversion now.\n");
        ...
        printf("Do second time EADC conversion now.\n");
        ...
        printf("SECOND, you can check Valid status ...   Valid bit = %lu\n", (EADC->DAT[0] & EADC_DAT0_ADC0VALID_Msk) >> EADC_DAT0_ADC0VALID_Pos);
