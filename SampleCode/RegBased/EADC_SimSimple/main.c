 ...
 * $Revision: 1 $
 * $Date: 17/07/19 6:46p $
 * @brief    Sample code for EADC Simultaneous Simple mode.
 * @note
...
int main()
{
     ...
     */
    printf("+--------------------------------------------------+\n");
    printf("| Mini57 EADC Simultaneous Simple Mode Sample Code |\n");
    printf("+--------------------------------------------------+\n");
    ...
    /* Configure EADC conversion mode to Simultaneous Simple Mode */
    EADC->CTL = (EADC->CTL & ~(EADC_CTL_ADC0CHSEL_Msk | EADC_CTL_ADC0HWTRGEN_Msk | EADC_CTL_ADC1CHSEL_Msk | EADC_CTL_ADC1HWTRGEN_Msk | EADC_CTL_ADCMODE_Msk)) |
                ((EADC_EADC0_0 << EADC_CTL_ADC0CHSEL_Pos) | ((EADC_EADC1_0 - EADC_EADC1_0) << EADC_CTL_ADC1CHSEL_Pos) | (0x2 << EADC_CTL_ADCMODE_Pos) | EADC_CTL_ADCEN_Msk);
