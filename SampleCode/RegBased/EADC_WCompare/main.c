...
void EADCWCMP_IRQHandler(void)
{
    ...
    EADC->STATUS = EADC_STATUS_WCMPIF_Msk;
...
int main()
{
    ...
    EADC_EnableWCMP(EADC, 3000,        NULL,       EADC_WCMP_HIGH_ENABLE, 5,             EADC_WCMP_FLAG_AUTO_UPDATE);

    /* EADC_ENABLE_CMP_INT(EADC, NULL); */
    EADC->WCMPCTL |= EADC_WCMPCTL_WCMPIEN_Msk;
