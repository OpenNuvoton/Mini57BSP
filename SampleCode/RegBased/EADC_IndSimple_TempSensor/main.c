...
int main()
{
    ...
    EADC->CTL = (EADC->CTL & ~(EADC_CTL_ADC1CHSEL_Msk | EADC_CTL_ADC1HWTRGEN_Msk | EADC_CTL_ADCMODE_Msk)) |
                ((EADC_EADC1_6 << EADC_CTL_ADC1CHSEL_Pos) | (0x0 << EADC_CTL_ADCMODE_Pos) | EADC_CTL_ADCEN_Msk);
