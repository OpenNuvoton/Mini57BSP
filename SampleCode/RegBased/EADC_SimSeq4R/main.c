...
int main()
{
    ...
    EADC->CTL = (EADC->CTL & ~(EADC_CTL_ADCMODE_Msk | EADC_CTL_ADCSS3R_Msk | EADC_CTL_ADC0SEQSEL_Msk | EADC_CTL_ADC1SEQSEL_Msk))
                | (0x3 << EADC_CTL_ADCMODE_Pos) | (EADC_EADC0_6 << EADC_CTL_ADC0SEQSEL_Pos) | ((EADC_EADC1_3 - EADC_EADC1) << EADC_CTL_ADC1SEQSEL_Pos);
    ...
    while (ch != 'q')
    {
        ...
        printf("Get EADC0 FIFO 0 data = %4d (valid = %s)\n",
                ...
                (dataVaidFlag & EADC_BIT_MASK_EADC0) ? "Yes" : "No");
        ...
        printf("Get EADC1 FIFO 0 data = %4d (valid = %s)\n",
                ...
                (dataVaidFlag & EADC_BIT_MASK_EADC1) ? "Yes" : "No");
        ...
        printf("Get EADC0 FIFO 1 data = %4d (valid = %s)\n",
                (EADC->DAT[1] & EADC_DAT1_ADC0DAT1_Msk) >> EADC_DAT1_ADC0DAT1_Pos,
                (dataVaidFlag & EADC_BIT_MASK_EADC0_DAT1) ? "Yes" : "No");
        ...
        printf("Get EADC1 FIFO 1 data = %4d (valid = %s)\n",
                (EADC->DAT[1] & EADC_DAT1_ADC1DAT1_Msk) >> EADC_DAT1_ADC1DAT1_Pos,
                (dataVaidFlag & EADC_BIT_MASK_EADC1_DAT1) ? "Yes" : "No");
